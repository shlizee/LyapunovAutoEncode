...
class SMNISTTrails(object):
    def __init__(self, fcon, min_pval=0.1, max_pval=50, hidden_size=512, evals=300, keep_amt=0.4, model_type='lstm'):
...
if __name__ == '__main__':
    import sys
    main(sys.argv[1:])
    # extract_trials(64, 'trials/SMNIST/asrnn/', model_type='asrnn', task_type='SMNIST')
